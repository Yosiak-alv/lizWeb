...
<template>
    <nav class="fixed w-full z-10 top-0 left-0 backdrop-blur-lg bg-white/30 p-1">
            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <NavLink  @click="setCurrentSelection('inicio')" href="#inicio" :active="(currentSelection == 'inicio' ? true :false)">
                            Inicio
                        </NavLink>
                ...
                <div class="flex space-x-2 pt-4">
                    <div>
                        <a href="https://www.instagram.com/liz_alvare?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" class="text-gray-500 hover:text-green-900">
                    ...
                    <div>
                        <a href="https://www.linkedin.com/in/elizabeth-alvarenga-/" target="_blank" class="text-gray-500 hover:text-green-900">
                    ...
                    <div>
                        <a href="mailto:liz.alvare@gmail.com" target="_blank" class="text-gray-500 hover:text-green-900">
        ...
        >
            <div class="pt-2 pb-3 space-y-1">
                <ResponsiveNavLink @click="setCurrentSelection('inicio')" :href="'#inicio'" :active="(currentSelection == 'inicio' ? true :false)">
                    Inicio
                </ResponsiveNavLink>
