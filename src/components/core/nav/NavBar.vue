...
const getCurrentRoute = (currentName) => {
    const name  = computed(() => router.name);
    return name.value === currentName ? true : false;
}
</script>
<template>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
            <div class="flex justify-between h-16">
                ...
                <div class="flex space-x-2 pt-4">
                    ...
                    <div>
                        <a href="https://www.linkedin.com/in/elizabeth-alvarenga-/" target="_blank" class="text-gray-500 hover:text-green-600">
                    ...
                    <div>
                        <a href="mailto:liz.alvare@gmail.com" target="_blank" class="text-gray-500 hover:text-green-600">
