...
<template>
    <footer class="text-gray-900 bg-white shadow mt-4 mx-auto">
        <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
            ...
            <span class="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
                <a href="tel:+50377493748" target="_blank" class="mr-2 text-gray-500 hover:text-green-600">
                ...
                <a href="https://www.linkedin.com/in/elizabeth-alvarenga-/" target="_blank" class="ml-3 text-gray-500 hover:text-green-600">
                ...
                <a href="mailto:liz.alvare@gmail.com" target="_blank" class="ml-3 text-gray-500 hover:text-green-600">
                    <svg  xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="w-6 h-6 icon icon-tabler icons-tabler-outline icon-tabler-mail"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M3 7a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v10a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-10z" /><path d="M3 7l9 6l9 -6" /></svg>
                </a>
            </span>
        </div>
    </footer>
