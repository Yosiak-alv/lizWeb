    ...
    <footer class="text-gray-900 bg-white shadow m-4 mx-auto">
        <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
            ...
            <span class="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
                ...
                <a href="https://www.linkedin.com/in/elizabeth-alvarenga-/" target="_blank" class="ml-3 text-gray-500 hover:text-green-900">
                ...
                <a href="mailto:liz.alvare@gmail.com" target="_blank" class="ml-3 text-gray-500 hover:text-green-900">
